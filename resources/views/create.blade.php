    ...
    @endif
      <form method="post" action="{{ route('annonces.store') }}">
          <div class="form-group">
              ...
              <input type="textarea" class="form-control" name="annonce"/>
          </div>
          
          <button type="submit" class="btn btn-block btn-danger">Publier une annonce</button>
      </form>
  </div>
</div>
</div></div></div>
